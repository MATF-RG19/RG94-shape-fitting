...
void draw_picture_shapes(Shapes picture_array[]){
		...
		glPushMatrix();
				...
				glScalef(0.3,0.3,0);
				glBegin(GL_POLYGON);
                    a[1]=picture_array[3].x;
                    a[2]=picture_array[3].y;
                    a[3]=picture_array[3].z;
                    b[1]=picture_array[3].x;
                    b[2]=picture_array[3].y+1;
                    b[3]=picture_array[3].z;
                    c[1]=picture_array[3].x+1;
                    c[2]=picture_array[3].y+1;
                    c[3]=picture_array[3].z;
		...
		glPushMatrix();
				...
				glScalef(0.3,0.3,0);
				glBegin(GL_POLYGON);
                    a[1]=picture_array[4].x;
                    a[2]=picture_array[4].y;
                    a[3]=picture_array[4].z;
                    b[1]=picture_array[4].x;
                    b[2]=picture_array[4].y+1;
                    b[3]=picture_array[4].z;
                    c[1]=picture_array[4].x-1;
                    c[2]=picture_array[4].y+1;
                    c[3]=picture_array[4].z;
                    rez=calculate_normal(a,b,c);
                    glNormal3f(rez[0],rez[1],rez[2]);
		...
		glPushMatrix();
				...
				glScalef(0.3,0.3,0);
				glBegin(GL_POLYGON);
                    a[1]=picture_array[7].x;
                    a[2]=picture_array[7].y;
                    a[3]=picture_array[7].z;
                    b[1]=picture_array[7].x-0.75;
                    b[2]=picture_array[7].y+0.75;
                    b[3]=picture_array[7].z;
                    c[1]=picture_array[7].x-1.5;
                    c[2]=picture_array[7].y;
                    c[3]=picture_array[7].z;
                    rez=calculate_normal(a,b,c);
                    glNormal3f(rez[0],rez[1],rez[2]);
		...
		glPushMatrix();
				...
				glScalef(0.3,0.3,0);
				glBegin(GL_POLYGON);
                    a[1]=picture_array[8].x;
                    a[2]=picture_array[8].y;
                    a[3]=picture_array[8].z;
                    b[1]=picture_array[8].x+0.75;
                    b[2]=picture_array[8].y+0.75;
                    b[3]=picture_array[8].z;
                    c[1]=picture_array[8].x+1.5;
                    c[2]=picture_array[8].y;
                    c[3]=picture_array[8].z;
                    rez=calculate_normal(a,b,c);
                    glNormal3f(rez[0],rez[1],rez[2]);
